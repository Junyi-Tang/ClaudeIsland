...
while ($true) {
    ...
    $screen = [System.Windows.SystemParameters]::WorkArea
            ...
            # Kill the hidden Win32 border chrome that leaks on the left edge
            ...
            $card.CornerRadius = New-Object System.Windows.CornerRadius(26) # Sleek modern squircle pill
            ...
            $card.Padding = New-Object System.Windows.Thickness(20, 0, 20, 0) # Equalized breathing room
            ...
            $iconBadge.CornerRadius = New-Object System.Windows.CornerRadius(12) # Soft square geometry
            ...
            # Smooth cubic easing curves instead of linear snaps
            ...
            $ef.BeginTime = [System.TimeSpan]::FromSeconds(8) # Shortened auto-dismiss window for clean UX
